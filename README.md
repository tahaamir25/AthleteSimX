...
- Create a new athlete or load a previously saved one
- Choose between different athlete types:
  - Soccer Player
  - Basketball Player
  - Boxer
- Train, feed, or play matches with your athlete
- Sport-specific activities such as dunking, sparring, and free kicks
- Track athlete stats:
  - Happiness
  - Strength
  - Hunger
...
The game then shows a menu where you can perform different actions with your athlete.
...
Each action affects the athlete's stats.

For example:

- Training increases strength but decreases hunger
- Playing increases happiness but reduces strength and hunger
- Feeding increases hunger but reduces happiness
